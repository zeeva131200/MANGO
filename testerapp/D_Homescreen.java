...
public class D_Homescreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.d_homescreen);

//        ImageButton offerRide = findViewById(R.id.offerRideBtn);
//
//        offerRide.setOnClickListener(new View.OnClickListener(){
//            public void onClick(View v){
//                startActivity(new Intent(D_Homescreen.this,D_browseRide.class));
//            }
//        });
    ...
    //set activity fragment
        getSupportFragmentManager().beginTransaction()
                ...
                .replace(R.id.fragmentContainer, D_HomeFragment.class,null)
                .commit();
