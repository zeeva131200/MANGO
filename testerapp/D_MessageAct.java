...
public class D_MessageAct extends AppCompatActivity {
...
//        getSupportActionBar().setTitle("");
        ...
        db.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(D_MessageAct.this, "Fail to get data.", Toast.LENGTH_SHORT).show();
                ...
                db.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                         //   for (DataSnapshot rideshot : dataSnapshot.getChildren()) {
                                String key = dataSnapshot.getKey();
                                Toast.makeText(D_MessageAct.this, "a : "+key, Toast.LENGTH_SHORT).show();
                                String msg = text_send.getText().toString();
                                if(!msg.equals("")){
                                    sendMsg(fuser.getUid(), key, msg);
                                }
                                else {
                                    Toast.makeText(D_MessageAct.this, "You can't send empty message", Toast.LENGTH_SHORT).show();
                                }
                                text_send.setText("");
                                //   }
                        }
        ...
        db.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    if(chat_item.getReceiver().equals(userId) && chat_item.getSender().equals(myId) || chat_item.getReceiver().equals(userId) || chat_item.getSender().equals(myId)){
                        mChat.add(chat_item);
                    }
                    msgAdapter = new Message_Adapter(D_MessageAct.this, mChat);
